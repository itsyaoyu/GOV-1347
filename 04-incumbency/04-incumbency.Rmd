...
ic_2017_graph <- ic_2017 %>% 
  ggplot(aes(x = date, y = total, color = fct_relevel(committee_name, "DONALD J. TRUMP FOR PRESIDENT, INC.", "BIDEN FOR PRESIDENT"))) + 
  geom_line() + 
  theme_classic() +
...
ic_2017_graph_plotly <- ggplotly(ic_2017_graph)
