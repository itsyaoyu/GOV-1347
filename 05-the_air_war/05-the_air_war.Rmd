...
ad_campaigns <- read_csv("../data/05-the_air_war/ad_campaigns_2000-2012.csv")
ad_2020 <- read_csv("../data/05-the_air_war/ads_2020.csv")
vep <- read_csv("../data/05-the_air_war/vep_1980-2016.csv")
```
...
# png("tv_ad_ec_bar.png", units="in", width=4, height=2, res=300)
# print(ec_plot)
# dev.off()
```
